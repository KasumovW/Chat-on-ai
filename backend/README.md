...
```
ollama pull dimweb/ilyagusev-saiga_llama3_8b:Q6_K
```
...
```
ollama pull dimweb/ilyagusev-saiga_llama3_8b:Q6_K
set MODEL=dimweb/ilyagusev-saiga_llama3_8b:Q6_K && python privateGPT.py
set MODEL=dimweb/ilyagusev-saiga_llama3_8b:Q6_K && python privateGPTAPI.py
```
